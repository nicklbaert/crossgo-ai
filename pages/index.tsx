...
const Home: NextPage = () => {
  ...
  return (
    <div className={styles.wrapper}>
      <div className={styles.purple_background}></div>
      <div className={styles.content}>
        ...
        <div className={styles.login_box}>
          ...
          <BasicInputField label="Email Adresse" onChange={(s: string) => {}} />
          <Spacer type="vertical" size={24} />
          <BasicInputField
            isPassword={true}
            label="Passwort"
          ...
          <div className={styles.disclaimer}>
            Deine Daten werden verschlüsselt übertragen. Für mehr Informationen
