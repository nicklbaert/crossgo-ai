...
const firebaseErrors: Record<string, TranslateObject> = {
    ...
    "auth/id-token-expired": {
        ...
        toClient: "Deine Sitzung ist abgelaufen, bitte melde dich erneut an."
    },
    "auth/id-token-revoked": {
        toDev: "The Firebase ID token has been revoked.",
        toClient: "Deine Sitzung ist abgelaufen, bitte logge dich erneut ein."
    },
    ...
    "auth/invalid-display-name": {
        ...
        toClient: "Ungültiger Anzeigename."
    },
    ...
    "auth/invalid-email": {
        ...
        toClient: "Ungültige E-Mail Adresse."
    },
    ...
    "auth/invalid-password": {
        ...
        toClient: "Das Passwort muss mindestens 6 Zeichen lang sein."
    },
    ...
    "auth/invalid-phone-number": {
        ...
        toClient: "Die angegebene Telefonnummer ist ungültig. Sie muss eine nicht-leere E.164-konforme Zeichenfolge sein."
    },
    ...
    "auth/phone-number-already-exists": {
        ...
        toClient: "Die angegebene Telefonnummer wird bereits von einem anderen Benutzer verwendet."
    },
    ...
    "auth/user-not-found": {
        ...
        toClient: "Dieser Nutzer existiert nicht."
    },
}


export function getFirebaseErrorTranslation(error: string): TranslateObject {
